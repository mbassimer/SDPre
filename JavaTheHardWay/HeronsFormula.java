public class HeronsFormula {
  ...
  //1. The one without the functions is the longest code.
  //2. It would require you to add additional code to 6 different parts of the code
  //3. No, it wasn't difficult to add. It would of been more difficult adding it do a
